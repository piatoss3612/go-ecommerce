...
// use intuitive, meaningful method name
...
// get payment method by pament method id
...
// retrieve payment intent by existing payment intent id as payment intent changes during its life cycle
